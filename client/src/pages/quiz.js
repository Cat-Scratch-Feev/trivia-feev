      ...
      {quizState === "start" && questions.length > 0 && currentQuestionData ? (
        <div className="quiz__wrap quiz__wrap--start">
          ...
          <section className="quiz__directions--blurb">
            <h3>
              you have chosen the {currentQuestionData.category} category!
            </h3>
            <p>
              you will have <span className="quiz__directions--bold">10</span>{" "}
              seconds per question, with a{" "}
              <span className="quiz__directions--bold">5</span> second penalty
              for incorrect answers.
            </p>
            <p>your quiz will begin when you press start!</p>

            <button className="quiz__start-button" onClick={handleStartQuiz}>
              start
            </button>
          </section>
        </div>
